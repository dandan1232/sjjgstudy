...
//	private static int count=0;                  //记载比较次数
    ...
    private static int[] getNextk(MyString pattern)   //返回模式串pattern的next数组
    {
    ...
    {
        MyString target=new MyString("abcabb"), pattern=new MyString("abb");//图3.14（a）  目标串不回溯 
...
//          String target="abcababcabababcababc", pattern="ababcababc"; //思考题3-6，习题解答3-10(6)，习图3.7
        ...
        System.out.println("KMP.indexOf(\""+target+"\", \""+pattern+"\")="+KMP_MyString.indexOf(target, pattern));
    }
}
...
*/
//@author：Yeheya。2015年2月7日，2019年9月29日