//《数据结构与算法（Java版）（第5版）》，作者：叶核亚，2019年10月27日
...
//        AdjListGraph<String> graph = new AdjListGraph<String>(vertexes, edges);
...
以A作为中间顶点，替换路径如下：
(B,C)路径长度11，替换为(B,A),(A,C)路径长度16777272？否
(B,D)路径长度43，替换为(B,A),(A,D)路径长度16777280？否
(C,B)路径长度16777215，替换为(C,A),(A,B)路径长度55？是，d21=55，p21=0
(C,D)路径长度9，替换为(C,A),(A,D)路径长度104？否
(D,B)路径长度16777215，替换为(D,A),(A,B)路径长度38？是，d31=38，p31=0
(D,C)路径长度16777215，替换为(D,A),(A,C)路径长度79？是，d32=79，p32=0
dist：
     0    16    57    65
     ∞     0    11    43
    39    55     0     9
...
(C,A)路径长度39，替换为(C,A,B),(B,A)路径长度16777270？否
(C,D)路径长度9，替换为(C,A,B),(B,D)路径长度98？否
(D,A)路径长度22，替换为(D,A,B),(B,A)路径长度16777253？否
...
(B,A)路径长度16777215，替换为(B,C),(C,A)路径长度50？是，d10=50，p10=2
...
*/
//@author：Yeheya。2014年8月9日，2019年10月27日